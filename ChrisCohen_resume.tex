...
\cvitem{
  ...
  \cvtitle{Bachelor of Science at Purdue University}
    ...
    \begin{itemize}[leftmargin=*]
      ...
      \normalsize
      \item 6x Dean's List \hspace{20mm} 5x Semester Honors
    \end{itemize}
}
...
\cvitem{
    ...
    \normalsize
    \begin{itemize}[leftmargin=*]
        \item Developed an Android app for a Qualcomm chipset feature that ensures secure wireless connection, and
          communicates the location of malicious access points to the user.
        \item Innovated an AI-powered system that processes raw media from non-AI devices, plotting important objects onto a map for the user to view.
    \end{itemize}
    \vspace{2mm}
}
...
\cvitem{
    ...
    \begin{itemize}[leftmargin=*]
      ...
      \item Asynchronous Inter-Process Communication (IPCa
