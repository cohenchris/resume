...
\setlength{\cvleftcolumnwidth}{40mm}
...
\cvitem{
    ...
    \begin{itemize}[leftmargin=*]
      \item MEMORY MANAGEMENT
        \subitem - Paging, Virtualization, and Cache Memory Hierarchy
        \subitem - Runtime Stack and Heap Management

      \item OS AND SYSTEMS PROGRAMMING
        \subitem - Software/Hardware Interrupts and Device Management
        \subitem - Asynchronous Inter-Process Communication
        \subitem - Return-Oriented Programming
        \subitem - Concurrency and Parallelism (Semaphores, Locks, Forking, Threading, Scheduling)

      \item OSI/ISO 7-LAYER NETWORK MODEL
        \subitem - UDP, TCP, methods for reliable data transport
        \subitem - IP addressing/routing, DHCP, and DNS translation
        \subitem - ARP, MAC addressing/routing, Multiple-access protocols for link-layer
...
\cvitem{
    ...
    \cvtitle{Operating Systems - Process Hijacking in XINU}

    \begin{itemize}[leftmargin=*]
        \item Manipulated a victim process by locating and modifying return addresses and local variables in the runtime stack
        \item Learned about protection against this sort of attack (stack canaries)
...
\cvitem{
    ...
    \cvtitle{Systems Programming - Shell Interpreter in C}
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item Forking subshell execution
    \end{itemize}
}
