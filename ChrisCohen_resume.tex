...
\setlength{\cvafteritemskipamount}{6mm plus 1.25mm minus 1.25mm}

% vertical space after sections
\newlength{\cvaftersectionskipamount}
\setlength{\cvaftersectionskipamount}{4mm plus 0.5mm minus 0.5mm}
...
\cvitem{
    ...
    \begin{itemize}[leftmargin=*]
      ...
      \item Worked with internal DRM team to use BCC for a new generation of our Remote Key Provisioning feature.
        \begin{itemize}
          \item This allows for a variety of use-cases, including, including remote provisioning of a device as it leaves the factory, secure video playback, and remote device attestation for customers.
        \end{itemize}
    \end{itemize}
}
