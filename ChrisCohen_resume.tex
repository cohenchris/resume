...
\cvitem{
    ...
    \begin{itemize}[leftmargin=*]
      \item Currently hold a valid \textbf{Secret} security clearance.
      \item Approved for a valid \textbf{Top Secret} clearance. This clearance has lapsed - I voluntarily moved from Qualcomm government to corporate for cryptography work.
    \end{itemize}
  \vspace{1.5mm}
}
